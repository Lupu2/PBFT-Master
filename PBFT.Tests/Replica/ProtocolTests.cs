...
namespace PBFT.Tests
{
    ...
    public class ProtocolTests
    {
        ...
        public void ProtocolExecutionPrimaryNoPersistencyTest()
        {
            ...
            Server testserv = new Server(0,0,4,null,20,"127.0.0.1:9000", reqbridge, pesbridge, null,null, null, new CDictionary<int, string>());
            ProtocolExecution exec = new ProtocolExecution(testserv, 1, pesbridge, null, null);
        ...
        public void ProtocolExecutionNoPrimaryNoPersistencyTest()
        {
            ...
            Source<Request> reqbridge = new Source<Request>();
            Source<PhaseMessage> pesbridge = new Source<PhaseMessage>();
            Server testserv = new Server(1,0,4,null,20,"127.0.0.1:9000", reqbridge, pesbridge, null, null, null, new CDictionary<int, string>());
            ProtocolExecution exec = new ProtocolExecution(testserv,1, pesbridge, null, null);
