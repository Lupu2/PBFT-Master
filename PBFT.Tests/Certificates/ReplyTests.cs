...
namespace PBFT.Tests.Replica.Protocol
{
    ...
    public class ReplyCertificateTests
    {
        ...
        public void QReachedTests()
        {
            ...
            Assert.AreEqual(repcert.ProofList.Count, 0);
            var rep1 = new Reply(1, 1, 1, true, orgreq.Message, orgreq.Timestamp);
            repcert.ProofList.Add(rep1);
            Assert.IsFalse(repcert.WeakQReached(1));
            repcert.ProofList.Add(rep1);
            Assert.IsFalse(repcert.WeakQReached(1));
            var rep2 = new Reply(2, 2, 1, true, orgreq.Message, orgreq.Timestamp);
            ...
            var rep3 = new Reply(3, 3, 1, true, orgreq.Message, orgreq.Timestamp);
        ...
        public void ProofsValidTests()
        {
            ...
            var rep2 = new Reply(2, 1, 1, true, orgreq.Message, orgreq.Timestamp);
            repcert.ProofList.Add(rep2);
            Assert.IsFalse(repcert.ProofsAreValid()); //testing signature
            rep2.SignMessage(pri);
            Assert.IsTrue(repcert.ProofsAreValid());
            var rep3 = new Reply(3, 1, 1, false, "", orgreq.Timestamp);
            ...
            Assert.AreEqual(repcert.ProofList.Count, 0);
            var rep1f = new Reply(1, 2, 1, false, "Failure", orgreq.Timestamp);
            var rep2f = new Reply(2, 2, 1, false, "Failure", orgreq.Timestamp);
            var rep3f = new Reply(3, 2, 1, false, "Failure", orgreq.Timestamp);
        ...
        public void ValidateCertificateTest()
        {
            ...
            var rep1 = new Reply(1, 1, 1, true, req1.Message, req1.Timestamp);
            var rep2 = new Reply(2, 1, 1, true, req1.Message, req1.Timestamp);
            var rep3 = new Reply(3, 1, 1, true, req1.Message, req1.Timestamp);
            var rep4 = new Reply(1, 1, 1, true, req2.Message, req2.Timestamp);
            var rep5 = new Reply(2, 1, 1, true, req2.Message, req2.Timestamp);
            var rep6 = new Reply(3, 1, 1, true, req2.Message, req2.Timestamp);
            var rep1f = new Reply(1, 1, 1, false, "Failure", req1.Timestamp);
            var rep2f = new Reply(1, 1, 1, false, "Failure", req1.Timestamp);
            var rep3f = new Reply(1, 1, 1, false, "Failure", req1.Timestamp);
            //Signature check
