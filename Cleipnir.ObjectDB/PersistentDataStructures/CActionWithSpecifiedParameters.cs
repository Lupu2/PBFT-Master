...
namespace Cleipnir.ObjectDB.PersistentDataStructures
{
    ...
    public class CActionWithSpecifiedParameters<T> : IPersistable
    {
        ...
        private static CActionWithSpecifiedParameters<T> Deserialize(IReadOnlyDictionary<string, object> sd)
        {
